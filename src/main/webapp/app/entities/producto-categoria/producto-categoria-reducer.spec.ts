...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './producto-categoria.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTOCATEGORIA_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUCTOCATEGORIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUCTOCATEGORIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUCTOCATEGORIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTOCATEGORIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUCTOCATEGORIA actions', async () => {
      const expectedActions = [
        {
