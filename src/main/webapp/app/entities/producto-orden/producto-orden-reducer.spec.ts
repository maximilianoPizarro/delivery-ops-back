...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTOORDEN_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUCTOORDEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUCTOORDEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUCTOORDEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTOORDEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUCTOORDEN actions', async () => {
      const expectedActions = [
        {
