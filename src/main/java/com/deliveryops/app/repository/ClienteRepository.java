...
public interface ClienteRepository extends JpaRepository<Cliente, Long> {
    ...
    @Query(
        value = "select distinct cliente from Cliente cliente left join fetch cliente.user",
    ...
    @Query("select distinct cliente from Cliente cliente left join fetch cliente.user")
