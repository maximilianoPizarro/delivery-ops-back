...
public interface ProductoRepository extends JpaRepository<Producto, Long> {
    ...
    @Query(
        value = "select distinct producto from Producto producto left join fetch producto.productoCategoria",
    ...
    @Query("select distinct producto from Producto producto left join fetch producto.productoCategoria")
    List<Producto> findAllWithToOneRelationships();

    @Query("select producto from Producto producto left join fetch producto.productoCategoria where producto.id =:id")
