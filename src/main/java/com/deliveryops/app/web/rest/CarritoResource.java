...
import com.deliveryops.app.repository.CarritoRepository;
import com.deliveryops.app.service.CarritoService;
...
/**
 * REST controller for managing {@link com.deliveryops.app.domain.Carrito}.
 */
@RestController
@RequestMapping("/api")
public class CarritoResource {
    ...
    public ResponseEntity<Carrito> updateCarrito(
        ...
        Carrito result = carritoService.update(carrito);
        return ResponseEntity
            .ok()
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/carritos/{id}", consumes = { "application/json", "application/merge-patch+json" })
