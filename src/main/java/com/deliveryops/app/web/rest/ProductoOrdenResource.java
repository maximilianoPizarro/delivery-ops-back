...
/**
 * REST controller for managing {@link com.deliveryops.app.domain.ProductoOrden}.
 */
@RestController
@RequestMapping("/api")
public class ProductoOrdenResource {
    ...
    public ResponseEntity<ProductoOrden> updateProductoOrden(
        ...
        ProductoOrden result = productoOrdenService.update(productoOrden);
        return ResponseEntity
            .ok()
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/producto-ordens/{id}", consumes = { "application/json", "application/merge-patch+json" })
    ...
    public List<ProductoOrden> getAllProductoOrdens(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
