...
import com.deliveryops.app.repository.ProductoCategoriaRepository;
import com.deliveryops.app.service.ProductoCategoriaService;
...
/**
 * REST controller for managing {@link com.deliveryops.app.domain.ProductoCategoria}.
 */
@RestController
@RequestMapping("/api")
public class ProductoCategoriaResource {
    ...
    public ResponseEntity<ProductoCategoria> updateProductoCategoria(
        ...
        ProductoCategoria result = productoCategoriaService.update(productoCategoria);
        return ResponseEntity
            .ok()
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/producto-categorias/{id}", consumes = { "application/json", "application/merge-patch+json" })
    ...
    public ResponseEntity<List<ProductoCategoria>> getAllProductoCategorias(
